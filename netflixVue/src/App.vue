<template>
  <div class="fundo" id="principal">
    <topo titulo="Netflix" logoff="Logoff" usuario="nome"></topo>
    <div class="contain">
      <categoria id="categoria" v-for="categoria in categorias" :key="categoria.id" v-bind:titulo="categoria.titulo"
